...
public class DaoProspect {
    ...
    public static void creatProspect(Prospect prospect) throws Exception {
        ...
        String sql = " INSERT INTO prospect (`RAISONSOCIAL`, `NUMRUE`, `NOMRUE`, `CDPOSTAL`, `VILLE`,`TELEPHONE`, `MAIL`, `COMMENTAIRES`, `DATEPROSPECTION`, `PROSPECTINTERESSE`) VALUES (?,?,?,?,?,?,?,?,?,?)";
    ...
    public static void updateProspect(Prospect prospect) throws Exception {
        ...
        String sql = " UPDATE prospect SET RAISONSOCIAL=?, NUMRUE=?, NOMRUE=?, CDPOSTAL=?, VILLE=? , TELEPHONE=?, MAIL=?, COMMENTAIRES=?, DATEPROSPECTION=?, PROSPECTINTERESSE=? WHERE IDPROSPECT=? ";
