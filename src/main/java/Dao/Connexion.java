...
public class Connexion {
    ...
    public static Connection startConnection() throws Exception {
        ...
        try {
            ...
            dataProperties.load(Connexion.class.getClassLoader().getResourceAsStream("databaseClientProspect.properties"));
            //InputStream inputStream = classloader.getResourceAsStream("databaseClientProspect.properties");
            //Prospect.properties");
            ...
            MyLogger.LOGGER.log(Level.SEVERE, "Erreur sql", sqe.getMessage());
